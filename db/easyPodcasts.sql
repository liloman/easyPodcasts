...
CREATE TABLE "Podcasts" ("id" INTEGER PRIMARY KEY  NOT NULL ,"ref" VARCHAR NOT NULL  DEFAULT (null) ,"idRSS" INTEGER,"title" VARCHAR,"desc" VARCHAR DEFAULT (null) ,"listened" INTEGER,"downloaded" BOOL,"url" VARCHAR,"ranking" NUMERIC,"date" DATE DEFAULT (null) );
