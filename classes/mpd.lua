...
function MPD:initialize(name)
    self.name=name
    self:connect()
    if not self.con then print("Connection to mpd failed:"..self.err) end
end
...
function MPD:connect(host, port, reconnect)
